# Guaranteed Rate Programming Challenge for Team One Loan
 ...
 * an email to [Team One Loan][] with a [git bundle](https://git-scm.com/docs/git-bundle) (*not* a simpel zip) of your solution's repository.
 * a PR for this repo.
